...
public class SessionServiceImplTest {
    ...
    void testStartSession_Success() {
        ...
        Double userLatitude = 10.762622;
        Double userLongitude = 106.660172;
        ...
        // Act
        Long sessionId = sessionService.startSession(userId, orderId, vehicleId, userLatitude, userLongitude);
    ...
    void testStartSession_UserNotFound() {
        ...
        // Act & Assert
        RuntimeException exception = assertThrows(RuntimeException.class, () -> sessionService.startSession(userId, orderId, vehicleId, userLatitude, userLongitude));
